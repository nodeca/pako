...
function InflateState() {
  ...
  // TODO: 8 or 16 bits?
  this.codes = utils.array32Create(ENOUGH);       /* space for code tables */
...
function inflateResetKeep(strm) {
  ...
  state.lencode = utils.array32Create(ENOUGH);
...
function fixedtables(state) {
  ...
  if (virgin) {
    ...
    lenfix = utils.array32Create(512);
    distfix = utils.array32Create(32);
